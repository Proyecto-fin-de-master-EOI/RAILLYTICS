-- Dim_Estacion: catálogo de estaciones con los atributos
-- que Silver ya trae normalizados. Silver debe ser consistente por
-- estacion_id; el max() solo colapsa las repeticiones.
SELECT
    estacion_id,
